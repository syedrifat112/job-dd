...
###### In this assignment i create two json file.One file contain job data and second file contain job details .Then i  make header and banner .Banner component  has 2 side . one side showing  some text and other side showing a banner image my project done
